...
import { Col,Card,ListGroup,ListGroupItem, Container, Row } from 'react-bootstrap';
...
class Ejercicio2 extends React.Component {
  constructor(props) {
    ...
    this.state={
      formulario: <FormTel url='https://api-mobilespecs.azharimm.site/v2/brands'/>,
      carta: <Carta brand_slug='apple-phones-1'/>,
      tabla: <Telefonos url='https://api-mobilespecs.azharimm.site/v2/top-by-fans'/>,
    }
  }

  componentDidMount(){
    this.setState({
      tabla: <Telefonos url={this.state.formulario.props.url}/>,
      formulario: <FormTel/>,
      carta: <Carta brand_slug=''/>,
    })
  }
